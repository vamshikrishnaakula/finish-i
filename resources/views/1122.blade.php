<script type="text/javascript">
    ...
    <script>
        function getdata() {
            ...
            @foreach ($mydata as $value)
                if (val == "dropdown")
                    ...
                    document.getElementById("div1").innerHTML =
                    "<br>@foreach ($mydata as $value)<div class='input-style-2' ><input  type='text' name='opt[]' value= {{ $value }} /><button type='button' class='btn btn-danger' onclick='deletedata()'id='add_text'>delete</button></div>@endforeach<br><button type='button' class='btn btn-primary' onclick='adddata()' id='add_text'>Add</button>"
                else if (val == "radio")
                    document.getElementById("div1").innerHTML =
                    "<br>@foreach ($mydata as $value)<div class='input-style-2' ><input  type='text' name='opt[]' value= {{ $value }} /><button type='button' class='btn btn-danger' onclick='deletedata()'id='add_text'>delete</button><br></div>@endforeach<br><br><button type='button' class='btn btn-primary' onclick='adddata()' id='add_text'>Add</button>"
                else if (val == "select")
                    document.getElementById("div1").innerHTML =
                    "<br>@foreach ($mydata as $value)<div class='input-style-2' ><input type='text'name='opt[]' value='{{ $value }}'><button type='button' class='btn btn-danger' onclick='deletedata()'id='add_text'>delete</button><br></div>@endforeach <br><br><button type='button' class='btn btn-primary' onclick='adddata()' id='add_text'>Add</button>"
            @endforeach
        ...
        function deletedata() {
            $(document).on('click', '.input-style-3', function(e) {
                e.preventDefault();
                $(this).remove();
            });
        }
