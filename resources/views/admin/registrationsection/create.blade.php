    ...
    <div class="card shadow mt-2">
        <div class="card-body">
            ...
            <form name="registrationsectionForm" id="registrationsectionForm" class="registrationsectionForm" method="post"
                action="{{ route('registrationsection.store') }}" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                ...
                                <div class="input-style-1">
                                    ...
                                    <input type="text" name="name" class="form-control"  value="{{old('name')}}" placeholder="section_name">
                                    @error('name')
